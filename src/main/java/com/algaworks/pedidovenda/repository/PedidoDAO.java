...
public class PedidoDAO implements Serializable {
	...
	public Pedido porId(Pedido pedido) {
		return this.manager.find(Pedido.class, pedido.getId());
	}

	@SuppressWarnings("unchecked")
	public List<Parcela> verificaDividaPendentePorCliente(Pedido pedido) {
	...
	@SuppressWarnings("unchecked")
	public List<Parcela> verificaPedidoQuitado(Pedido pedido){
