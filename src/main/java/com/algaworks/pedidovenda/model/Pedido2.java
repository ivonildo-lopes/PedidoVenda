...
public class Pedido2 implements Serializable {
	...
	private List<ItemPedido2> itens = new ArrayList<>();
	...
	public void recalcularValorTotal() {
		...
		for (ItemPedido2 item : this.getItens()) {
	...
	public void adicionaItemVazio() {
		...
		if (this.isOrcamento()) {
			...
			ItemPedido2 item = new ItemPedido2();
	...
	public void removerItemVazio() {
		ItemPedido2 primeiroItem = this.getItens().get(0);
	...
	// get and set
		...
		public List<ItemPedido2> getItens() {
			return itens;
		}

		public void setItens(List<ItemPedido2> itens) {
			this.itens = itens;
		}
